...
public class UNumber implements Comparable<UNumber> {
	...
	public void mpy(UNumber that){
		System.out.println(that.toString()+"\t"+this.toString());
	...
	public double getDouble() {
		int numDigits = 20;							// Doubles are not accurate beyond 17 digits
		if ( d.length < 20 ) numDigits = d.length;	// If the value has fewer, use just that many
