...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		if (check("\n******************\n" + 
				...
				"     resultErrorMessageMV = \n" +
				"     resultErrorMessageET = \n" +
				"*******************\n\n", test.debugToString())) {
			numPassed++;
		...
		boolean flag = test.setOperand1("1234567890123456", "0.001");					// Perform the test
		...
		test.setOperand1ErrorMessageMV("Test message for operand1");				// Perform the test
		...
		if (check("\n******************\n" + 
				...
				"******************\n" + 
				"operand1 = +0.00000000000000000000E+0\n" +
				"     operand1ErrorMessageMV = Test message for operand1\n" +
				"     operand1ErrorMessageET = \n"+
				"     operand1Defined = false\n" +
				"operand2 = +0.00000000000000000000E+0\n" +
				"     operand2ErrorMessageMV = \n" +
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("Test message for operand1", test.getOperand1ErrorMessageMV())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		test.setOperand2ErrorMessageMV("Test message for operand2");				// Perform the test
		...
		if (check("\n******************\n" + 
				...
				"     operand1Defined = false\n" + 
				"operand2 = +0.00000000000000000000E+0\n" +
				"     operand2ErrorMessageMV = Test message for operand2\n" +
				"     operand2ErrorMessageET = \n"+
				"     operand2Defined = false\n" + 
				"result = +0.00000000000000000000E+0\n" +
				"     resultErrorMessageMV = \n" +
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("Test message for operand2", test.getOperand2ErrorMessageMV())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		test.setResultErrorMessageMV("Test message for result");					// Perform the test
		...
		if (check("\n******************\n" + 
				...
				"     operand2Defined = false\n" + 
				"result = +0.00000000000000000000E+0\n" +
				"     resultErrorMessageMV = Test message for result\n" +
				"     resultErrorMessageET = \n"+
				"*******************\n\n", test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("Test message for result", test.getResultErrorMessageMV())) {
			numPassed++;
			System.out.println("\tPass");
		}
		// If they do not match, display that there was a failure and tally that result
		...
		test.setOperand1("1234", "0.1");
		test.setOperand2("8765", "0.1");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = +0.10816E+8;1000\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 0.140845059;+0.00000000000000000000E-16\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
