...
public class ErrorTermRecognizer {
	...
	public static String checkErrorTerm(String input) {
		...
		while (running) {
			...
			case 2: 
				// State 2 has one valid transitions.  It is addressed by an if statement.
			...
			case 3:
				// State 3 has only two valid transitions.  Each is addressed by an if statement.
			...
			case 4: 
				// State 4 has one valid transition.  It is addressed by an if statement.
			...
			case 8:
				//State 8 has one valid transition. Each is addressed by an if statement
			...
			case 9:
				//State 9 has two valod transitions. Each is addressed by an if statement
		...
		case 1:
			...
			if (currentCharNdx<input.length()) {
				...
				// forward.
				errorTermErrorMessage = "This character may only be an \"E\", an \"e\", a digit, "+ "a \".\"\n";
		...
		case 8:
			...
			errorTermErrorMessage = "This character may only be a .\n";
			return errorTermErrorMessage; // + displayInput(input, currentCharNdx);
